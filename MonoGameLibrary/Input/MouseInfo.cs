...
public class MouseInfo
{
    ...
    {
            //No hay opcion, el mouse state no puede ser cambiado por que su propiedad position es privada
            // a si que la unica opcion es crear uno nuevo. Como solo es un objeto sieno eliminado
            //calculo no habra un gran efecto. 
